...
import type { Client, SalesRepresentative } from "@/lib/db"

// Define the form schema with Zod (same as add client form)
...
export function EditClientForm({
  ...
  // Initialize the form with client values
  const form = useForm<ClientFormValues>({
    ...
    defaultValues: {
      ...
      pan_gst_number: client.pan_gst_number || "",

      lead_source: client.lead_source || undefined,
      account_owner_id: client.account_owner_id || undefined,
      sales_stage: client.sales_stage || undefined,
      deal_value: client.deal_value || undefined,
      target_close_date: client.target_close_date ? new Date(client.target_close_date) : undefined,
      probability_to_close: client.probability_to_close || 0,
      notes: client.notes || "",

      products_interested: client.products_interested || [],
      pricing_model: client.pricing_model || undefined,
      custom_requirements: client.custom_requirements || "",
      tc_compliance_status: client.tc_compliance_status || undefined,

      onboarding_status: client.onboarding_status || undefined,
      csm_assigned: client.csm_assigned || "",
      support_channels: client.support_channels || [],
  ...
  // The form JSX is identical to the AddClientForm, except for the button text
  // and the form is pre-populated with client data
  return (
    <Form {...form}>
          ...
          <TabsContent value="client-info">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Update the basic information about the client</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="stakeholders">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage stakeholders from the client detail page</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Stakeholders can be managed from the client detail page after saving your changes.
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="sales-funnel">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Update details about the sales process</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
          ...
          <TabsContent value="product-details">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Update details about products and commercial terms</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  control={form.control}
          ...
          <TabsContent value="post-sale">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Update details for after the sale is closed</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
